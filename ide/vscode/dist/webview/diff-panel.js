...
export class DiffPanel {
    ...
    onAcceptAll;
    disposables = [];
    constructor(panel, changes, onAcceptAll) {
        this.panel = panel;
    ...
    static createOrShow(context, changes, onAcceptAll) {
